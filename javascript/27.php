...
<?php
$con = mysqli_connect("localhost","root","","db_form") or die("connection failed");

$query = "insert into tbl_form(Name,Email_id,Number,Gender)values('$name','$email','$number','$gender')";
$res = mysqli_query($con,$query);


$query2 = "select * FROM tbl_form";
