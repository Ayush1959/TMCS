<template>
  <div>
    ...
    <div v-else>
      ...
      <button @click="Registerrr">Register</button>
      <div v-if="signInn">
        <div class="container">
          <div class="flex-grid justify-center">
            <div class="col-2">
              ...
              <div class="text-center push-top">
                <button class="btn-red btn-xsmall" @click="inGoogle">
  ...
  methods: {
    ...
    //   },
      ...
      register1(){
          ...
          this.dispatch('createUser', this.form)
            .then(alert("x"))
      },
      inGoogle() {
      ...
      register () {
        ...
        const database = firebase.database()
          firebase.auth().createUserWithEmailAndPassword(this.form.email,this.form.password)
            .then(() =>  database.ref('UserData').push({id:firebase.auth().currentUser.uid, name: x.form.name, username: x.form.username, email: x.form.email, password: x.form.password, avatar: x.form.avatar}))
            .catch(error => alert(error.message))
        // var x = this    
        // const database = firebase.database()
        // database.ref('Register').push({name: x.form.name, username: x.form.username, email: x.form.email, password: x.form.password, avatar: x.form.avatar})
        // x.messageText = ''
      }
  },
  created() {
