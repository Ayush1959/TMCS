<?php include 'includes/header.php';?>
    ...
    <main role="main" class="contact">
        ...
        <section class="contact-banner p-0 col-12">
            <div class="container position-relative text-right">
                <img src="images/contact-map.jpg" class="img-fluid d-none d-sm-block" />
                <div class="col-md-8 col-lg-7 col-xl-6 position-absolute contact-banner-text text-left" data-aos="fade-in" data-aos-duration="800">
            <h2 class="text-uppercase font-weight-normal ">Get in touch with us</h2>
<!--            <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard .</p>-->
            </div></div>
        </section>


        <div class="col-11 col-md-10 col-xl-8 m-auto contact-text p-4">
            <div class="row">
...
<!--                        <label for="dd1">Country :</label><br/>-->
                ...
                <div class="col-12 col-md-6 pr-0  contact-right ">
                    <h5 class="text-primary position-relative  font-weight-normal contact-right-head mb-4 mt-5 mt-md-0" data-aos="fade-in" data-aos-duration="800">Corporate Office</h5>
                    <address>
                        <p class="mb-2" data-aos="fade-in" data-aos-duration="1000">391B Orchard Road</p>
                        <p class="mb-2" data-aos="fade-in" data-aos-duration="1000">#23-01, Ngee Ann City Tower B</p>
                        <p class="mb-2" data-aos="fade-in" data-aos-duration="1000">Singapore 238874</p>
                        <p class="mb-2" data-aos="fade-in" data-aos-duration="1000">Tel: +65 6240 6950</p>
                        <p class="mb-2" data-aos="fade-in" data-aos-duration="1000">Fax:  +65 6832 8018 | 6491 5866</p>
                        <p class="mb-2" data-aos="fade-in" data-aos-duration="1000">Email: steiron@steiron.com</p>
                    </address>
